...
@section('content')
    <section class="" style="background-color: white; height: 92.5vh;">
        <div class="container py-5 h-100">
            <h3 class="text-center">First Day Attendance Information</h3>
            ...
            <div class="row justify-content-center my-4">
                ...
                <div class="col-3 ">
                    <form action="{{ route('firstDayDetail') }}" method="GET">
                        @csrf
                        <div class="d-flex">
            ...
            <table class="table table-striped mt-3 text-center">
              ...
              <div>
                {{ $firstDayData->appends(request()->query())->links() }}
              </div>
            {{-- end data table --}}
        </div>
    </section>
        ...
        function filterByCompany(){
            ...
            $.ajax({
                ...
                success: function(response){
                    let detail = response.first_filter_data.data;
                        let list = '';
                        let count = '';
                        ...
                        $new_date = $months[$date.getMonth()] +"-"+ $date.getDate() +"-"+ $date.getFullYear();
                            ...
                            count = `
                            <span>${response.first_people}</span>
                            <span class="symbol">/</span>
